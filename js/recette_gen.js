document.addEventListener('DOMContentLoaded', async () => {
    ...
    try {
        ...
        if (portionInput && recipe['Nb. de portion [base]']) {
            portionInput.value = recipe['Nb. de portion [base]'];
            portionInput.setAttribute('value', recipe['Nb. de portion [base]']);  // Définit également l'attribut HTML 'value'
        }
